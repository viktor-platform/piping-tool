...
class IMBROFile:
    ...
    def parse(
        self, additional_columns: List[str], verbose: bool = False, return_gef_data_obj: bool = False
    ) -> Union[dict, CPTData]:
    ...
    def convert_to_gef_file_content(self):
        ...
        headers = {
            ...
            "ZID": "{}, {}".format(
                zid_codes[cpt_data.deliveredVerticalPosition.verticalDatum], cpt_data.deliveredVerticalPosition.offset
            ),
            "XYID": "{}, {}, {}".format(
                xyid_codes[cpt_data.standardizedLocation.coordinateTransformation],
                *cpt_data.deliveredLocation.location.pos.split(" ")
            ),
            "MEASUREMENTTEXT": [
                "4, {}, conustype".format(cpt_data.conePenetrometerSurvey.conePenetrometer.conePenetrometerType),
                "5, {}, omschrijving sondeerapparaat".format(
                    cpt_data.conePenetrometerSurvey.conePenetrometer.description
                ),
                "6, {} / {}, sondeernorm en kwaliteitsklasse".format(
                    cpt_data.cptStandard, cpt_data.conePenetrometerSurvey.qualityClass
                ),
                ...
                "43, {}, methode locatiebepaling".format(cpt_data.deliveredLocation.horizontalPositioningMethod),
                ...
                "107, {}".format(cpt_data.deliveredVerticalPosition.verticalPositioningDate.date.replace("-", ", ")),
                "109, {}, dissipatietest uitgevoerd".format(cpt_data.conePenetrometerSurvey.dissipationTestPerformed),
                ...
                "116, {}".format(
                    replace_multiple(
                        cpt_data.registrationHistory.objectRegistrationTime[:19],
                        original_chars="-T:",
                        replace_char=", ",
                    )
                ),
                ...
                "118, {}".format(
                    replace_multiple(
                        cpt_data.registrationHistory.registrationCompletionTime[:19],
                        original_chars="-T:",
                        replace_char=", ",
                    )
                ),
            ...
            "MEASUREMENTVAR": [
                ...
                "13, {}, m (meter), voorgeboord tot".format(cpt_data.conePenetrometerSurvey.trajectory.predrilledDepth),
                "16, {}, m (meter), einddiepte".format(cpt_data.conePenetrometerSurvey.trajectory.finalDepth),
                "17, {}, -, stopcriterium".format(stop_criteria[cpt_data.conePenetrometerSurvey.stopCriterion]),
        ...
        data = ""
        data_rows = [
            row.split(token_separator) for row in cone_penetration_test.cptResult["values"].split(block_separator)[:-1]
        ]
