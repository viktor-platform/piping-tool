...
from .internal import PersistableStateLinePoint
from .internal import PersistableStatePoint
from .internal import PersistableStochasticParameter
from .internal import PersistableStress
from .internal import StateType
...
class DStabilityStress(DStabilityObject):
    ...
    def _to_internal_datastructure(self) -> PersistableStress:
        data = {**{snake_to_camel(name): value for name, value in self.dict(exclude={"stochastic_parameter"}).items()}}
