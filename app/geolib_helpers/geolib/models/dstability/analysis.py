...
from .internal import NullablePersistablePoint
from .internal import OptionsType
from .internal import PersistableBishopBruteForceSettings
from .internal import PersistableBishopSettings
from .internal import PersistableCircle
from .internal import PersistableGeneticSlipPlaneConstraints
from .internal import PersistableGridEnhancements
from .internal import PersistablePoint
from .internal import PersistableSearchArea
from .internal import PersistableSearchGrid
from .internal import PersistableSlipPlaneConstraints
from .internal import PersistableSpencerGeneticSettings
from .internal import PersistableSpencerSettings
from .internal import PersistableTangentArea
from .internal import PersistableTangentLines
from .internal import PersistableTwoCirclesOnTangentLine
from .internal import PersistableUpliftVanParticleSwarmSettings
from .internal import PersistableUpliftVanSettings
...
class DStabilityCircle(DStabilityObject):
    ...
    def _to_internal_datastructure(self) -> PersistableCircle:
        return PersistableCircle(Center=PersistablePoint(X=self.center.x, Z=self.center.z), Radius=self.radius)
...
class DStabilitySpencerGeneticAnalysisMethod(DStabilityAnalysisMethod):
    ...
    slip_plane_constraints: DStabilityGeneticSlipPlaneConstraints = DStabilityGeneticSlipPlaneConstraints()
