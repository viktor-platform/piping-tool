...
from geolib.models.dsettlement.loads import CircularLoad
from geolib.models.dsettlement.loads import RectangularLoad
from geolib.models.dsettlement.loads import TankLoad
from geolib.models.dsettlement.loads import TrapeziformLoad
...
from .internal import Boundary
from .internal import CalculationOptions
from .internal import ConsolidationModel
from .internal import Curve
from .internal import Dimension
from .internal import DSeriePoint
from .internal import DSettlementOutputStructure
from .internal import DSettlementStructure
from .internal import Layer
from .internal import Layers
from .internal import Model
from .internal import NonUniformLoad
from .internal import NonUniformLoads
from .internal import OtherLoads
from .internal import PiezoLines
from .internal import PointForLoad
from .internal import Points
from .internal import ResidualTimes
from .internal import Results
from .internal import SoilModel
from .internal import StrainType
from .internal import Verticals
from .internal import WaterLoads
...
class DSettlementModel(BaseModel):
    ...
    datastructure: Union[DSettlementStructure, DSettlementOutputStructure] = DSettlementStructure()
    ...
    def set_model(
        ...
        model_options.dimension = Dimension.TWO_D if is_two_dimensional else Dimension.ONE_D
    ...
    def set_any_calculation_options(self, **kwargs):
        ...
        self.datastructure.calculation_options = CalculationOptions.set_options(**calculation_options)
    ...
    def add_boundary(
        ...
        points = [
            self.points.add_point_if_unique(DSeriePoint.from_point(point), tolerance=tolerance) for point in points
        ]
    ...
    def add_head_line(self, points: List[Point], is_phreatic=False) -> int:
        ...
        points = [self.points.add_point(DSeriePoint.from_point(point)) for point in points]
        sorted_points = sorted(points, key=lambda point: (point.X, point.Y, point.Z))
        curves = self.curves.create_curves(sorted_points)
    ...
    def add_other_load(
        ...
        time: timedelta,
        point: Point,
        other_load: Union[TrapeziformLoad, RectangularLoad, CircularLoad, TankLoad, UniformLoad],
    ) -> None:
    ...
    def add_water_load(self, name: str, time: timedelta, phreatic_line_id: int):
        ...
        self.datastructure.water_loads.add_waterload(name, time.days, phreatic_line_id, headlines)
    ...
    def set_calculation_times(self, time_steps: List[timedelta]):
        ...
        """
        time_steps.sort()
        residual_times = ResidualTimes(time_steps=[timestep.days for timestep in time_steps])
