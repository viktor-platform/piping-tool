...
from geolib.models.dseries_parser import DSeriesRepeatedGroupsWithInlineMappedProperties
...
class DSeriesPilingParserStructure(DSeriesStructure):
    ...
    def parse_text(cls, text: str):
        ...
        if "[End of Input Data]" in text:
            ...
            text = text.replace("[End of Input Data]", "[End of Input Data]\n[OUTPUT DATA]")
...
class DSheetpilingTableEntry(DSeriesStructure):
    ...
    def parse_text(cls, text):
        ...
        name_field = " ".join(name_value for name_value in values[number_of_fields - 1 :] if name_value)
