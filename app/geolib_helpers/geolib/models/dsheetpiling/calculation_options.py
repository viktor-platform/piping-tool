...
class CalculationOptionsPerStage(BaseDataClass):
    ...
    partial_factor_set: Optional[Union[PartialFactorSetEC7NADB, PartialFactorSetCUR, PartialFactorSetEC7NADNL]] = None
...
class VerifyCalculationOptions(CalculationOptions):
    ...
    def allowable_anchor_force_calculation_type(self) -> bool:
        return (self.verify_type == VerifyType.CUR) or (self.verify_type == VerifyType.EC7NL)
