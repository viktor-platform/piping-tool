...
class PileProperties(BaseDataClass):
    ...
    material_type: Optional[SheetPilingElementMaterialType] = SheetPilingElementMaterialType.Steel
...
class SheetPileProperties(BaseDataClass):
    ...
    section_bottom_level: Optional[float] = None  # TODO important paramter, shouldn't be default
...
class DiaphragmWall(BaseDataClass):
    ...
    name: str = ""
    diaphragm_wall_properties: Optional[DiaphragmWallProperties] = DiaphragmWallProperties()
    plastic_properties: Optional[FullPlasticCalculationProperties] = FullPlasticCalculationProperties()
...
class Sheet(BaseDataClass):
    ...
    wooden_sheet_pile_properties: Optional[WoodenSheetPileProperties] = WoodenSheetPileProperties()
