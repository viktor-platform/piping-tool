...
from .internal import ModelTypeEnum
from .internal import PositionsBearingPiles
from .internal import PositionsTensionPiles
from .internal import PreliminaryDesign
...
from .piles import BearingPile
from .piles import BearingPileLocation
from .piles import Pile
from .piles import PileLocation
from .piles import TensionPile
from .piles import TensionPileLocation
...
class DFoundationsModel(BaseModel):
    ...
    def set_model(
        ...
        """
        logger.warning(
            "Setting model, " "prior made modifications in the current D-Foundations model might be overwritten."
        )
        ...
        self.datastructure.input_data.preliminary_design.profiles = list(range(len(self.profiles.profiles)))
        self.datastructure.input_data.soil_collection.soil = InternalSoil.default_soils(model=model.model_type().name)
    ...
    def add_pile_if_unique(self, pile: Pile, location: PileLocation):
        ...
        if isinstance(self.datastructure.input_data.preliminary_design, str):
            logger.warning("Overwriting unparsed calculation settings.")
            self.datastructure.input_data.preliminary_design = PreliminaryDesign()
        self.datastructure.input_data.preliminary_design.pile_types = list(range(len(piles)))
    ...
    def bearing_pile_locations(self):
        ...
        if isinstance(self.datastructure.input_data.positions___bearing_piles, str):
            self.datastructure.input_data.positions___bearing_piles = PositionsBearingPiles()
    ...
    def tension_pile_locations(self):
        ...
        if isinstance(self.datastructure.input_data.positions___tension_piles_cur, str):
            self.datastructure.input_data.positions___tension_piles_cur = PositionsTensionPiles()
