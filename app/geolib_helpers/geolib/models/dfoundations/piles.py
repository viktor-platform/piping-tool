...
from .internal import BearingPileSlipLayer
from .internal import LoadSettlementCurve
from .internal import PileMaterial
from .internal import PileShape
from .internal import PileType
from .internal import PileTypeForClayLoamPeat
from .internal import PositionBearingPile
from .internal import PositionTensionPile
from .internal import TypesBearingPiles
from .internal import TypesTensionPiles
...
class BearingPile(Pile):
    ...
    def _to_internal(self):
        return TypesBearingPiles(
            ...
            pile_type_for_execution_factor_clay_loam_peat=(self.preset_pile_class_factor_shaft_clay_loam_peat.value),
            ...
            overrule_pile_tip_cross_section_factors=(self.overrule_pile_tip_cross_section_factors),
...
class BearingRoundHollowPileWithClosedBase(BearingPile):
    ...
    def _to_internal(self):
        ...
        types_bearing_pile.internal_diameter = self.external_diameter - 2 * self.wall_thickness
...
class TensionRoundHollowPileWithClosedBase(TensionPile):
    ...
    def _to_internal(self):
        ...
        types_tension_pile.internal_diameter = self.external_diameter - 2 * self.wall_thickness
