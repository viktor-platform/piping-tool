...
from geolib.models.dseries_parser import DSeriesInlineProperties
...
from .dfoundations_structures import DFoundationsCPTCollectionWrapper
from .dfoundations_structures import DFoundationsEnumStructure
from .dfoundations_structures import DFoundationsInlineProperties
from .dfoundations_structures import DFoundationsTableWrapper
...
class InternalPile(BaseDataClass):
    ...
    def __eq__(self, other):
        ...
        if self.pile_name == other.pile_name:
            Warning("Pile with name: " + self.pile_name + " already exists, pile is not added.")
            return True
        else:
            return False
...
class DFoundationsInputStructure(DSeriesStructure):
    ...
    positions___tension_piles_cur: Union[PositionsTensionPiles, str] = PositionsTensionPiles()
